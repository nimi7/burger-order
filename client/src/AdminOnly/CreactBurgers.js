            ...
            <section class="min-h-screen flex items-stretch text-white ">
                ...
                <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0"style={{backgroundColor: "#161616"}}>
                    ...
                    <div class="w-full py-6 z-20">
                        ...
                        <form method='POST' action="/Burgers" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                            <div class="pb-2 pt-4">
                                <input type="Text" name="Food" id="email" placeholder="Food" class="block w-full p-4 text-lg rounded-sm bg-black" />
                            </div>
                            <div class="pb-2 pt-4">
                                <input class="block w-full p-4 text-lg rounded-sm bg-black" type="text" name="Discription" placeholder="Discription" />
                            </div>
                            <div class="pb-2 pt-4">
                                <input class="block w-full p-4 text-lg rounded-sm bg-black" type="text" name="WitheDiscription" placeholder="WitheDiscription" />
                            </div>
                            <div class="pb-2 pt-4">
                                <input class="block w-full p-4 text-lg rounded-sm bg-black" type="text" name="Pic" placeholder="Pic" />
                            </div>
                            <div class="pb-2 pt-4">
                                <input class="block w-full p-4 text-lg rounded-sm bg-black" type="Number" name="Price" placeholder="Price" />
                            </div>
                            <div class="pb-2 pt-4">
                                <input class="block w-full p-4 text-lg rounded-sm bg-black" type="text" name="Rating" placeholder="Rating" />
                            </div>
                            <div class="text-right text-gray-400 hover:underline hover:text-gray-100">
                                <a href="#">Forgot your password?</a>
                            </div>
                            <div class="px-4 pb-2 pt-4">
                                <button class="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">Creat Burger</button>
                            </div>
...
//     pathname: `/Burgers/edit/${props._id}`,
//     state: {
//         id: props._id,
//         Food: props.Food,
